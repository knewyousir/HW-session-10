...
The loading state is used to indicated that an asynchronous request is happening. Set an `isLoading` property in the constructor:
...
We turn it off once the data is loaded.
